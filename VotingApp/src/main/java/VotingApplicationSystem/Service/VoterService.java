...
import VotingApplicationSystem.exception.DuplicateResourceException;
...
public class VoterService {
	...
	public void deleteVoter(Long id) {
		Voter voter=voterRepository.findById(id).orElse(null);
		if(voter==null) {
			throw new ResourceNotFoundException("Cannot delete voter with id"+id+"as it does not found");
		}
